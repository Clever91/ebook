<div>
    <div class="form-group">
        ...
        <input type="number" class="form-control @error('page_count') is-invalid @enderror"
            id="page_count" name="page_count" value="{{ $detail->page_count }}"
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control @error('weight') is-invalid @enderror"
            id="weight" name="weight" value="{{ $detail->weight }}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('isbn') is-invalid @enderror"
            id="isbn" name="isbn" value="{{ $detail->isbn }}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('bar_code') is-invalid @enderror"
            id="bar_code" name="bar_code" value="{{ $detail->bar_code }}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('publisher') is-invalid @enderror"
            id="publisher" name="publisher" value="{{ $detail->publisher }}"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('year') is-invalid @enderror"
            id="year" name="year" value="{{ $detail->year }}"
