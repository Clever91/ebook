<footer>
    <div class="space-lg-2 border-top">
                    ...
                    <div class="pl-lg-7">
                        ...
                        <form class="js-validate js-form-message" novalidate="novalidate">
                            <div class="input-group">
                                <input type="email" class="form-control rounded-md py-4d75 font-size-2 pl-4 border-0 bg-gray-200 mr-1" name="email" id="subscribeSrEmail" placeholder="Enter email" aria-label="Your email" aria-describedby="subscribeButton" required="" data-msg="Please enter a valid email address.">
                                <div class="input-group-append">
                                    <button type="submit" class="btn btn-dark rounded-md text-white px-3 font-size-4 border-0 ml-2" id="subscribeButton">
