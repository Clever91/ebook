<header id="site-header" class="site-header__v13">
            ...
            <div class="row align-items-center position-relative">
                <div class="col-2 col-md-auto col-lg-5 position-static">
                    <div class="d-flex align-items-center">
                        <div class="offcanvas-toggler mr-3">
                        ...
                        <div class="site-navigation mr-auto d-none d-xl-block">
                            <ul class="nav">
                                <li class="nav-item dropdown">
                                    <a id="homeDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                                ...
                                <li class="nav-item"><a href="#" class="nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium">Categories</a></li>
                                <li class="nav-item dropdown">
                                    <a id="shopDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                                    ...
                                    <ul id="shopDropdownMenu" class="dropdown-unfold dropdown-menu font-size-2 rounded-0 border-gray-900" aria-labelledby="shopDropdownInvoker">
                                        ...
                                        <li class="position-relative">
                                            ...
                                            <ul id="shopDropdownsubMenutwo" class="dropdown-unfold dropdown-menu dropdown-sub-menu font-size-2 rounded-0 border-gray-900" aria-labelledby="shopDropdownsubmenutwoInvoker">
                                                ...
                                                <li><a href="../shop/single-product-v7.html" class="dropdown-item link-black-100">Shop Single v2</a></li>
                                ...
                                <li class="nav-item">
                                    <a id="featuresDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                          ...
                          <li><a href="../../starter/index.html" class="btn btn-secondary font-size-2 btn-block mb-2">Starter</a></li>
                                ...
                                <li class="nav-item dropdown">
                                    <a id="blogDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                                ...
                                <li class="nav-item dropdown">
                                    <a id="pagesDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-2 mx-wd-4 px-0 py-3 font-weight-medium d-flex align-items-center"
                                        aria-haspopup="true"
                                        aria-expanded="false"
                                        data-unfold-event="hover"
                ...
                <div class="col-auto col-md col-lg-5 position-static">
                    <ul class="nav justify-content-end">
                        <li class="nav-item d-none d-md-block">
                                ...
                                <form>
                                    ...
                                    <div class="input-group input-group-borderless u-search-slide-down__input rounded mb-2">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text font-size-3 nav-link link-black-100">
                            ...
                            <div class="position-relative">
                                <a id="searchSlideDownInvoker" class="shadow-none font-size-3 nav-link link-black-100 border-0 btn btn-xs btn-icon btn-text-secondary u-search-slide-down-trigger" href="javascript:;" role="button"
                                    ...
                                    <span class="flaticon-loupe btn-icon__inner u-search-slide-down-trigger__icon"></span>
                                </a>
                            </div>
                            <!-- End Search -->
                        </li>
                        <li class="nav-item d-none d-md-block"><a href="#" class="font-size-3 nav-link link-black-100"><i class="glph-icon flaticon-switch"></i></a></li>
                        <li class="nav-item d-none d-md-block"><a href="#" class="font-size-3 nav-link link-black-100"><i class="glph-icon flaticon-heart"></i></a></li>
                        <li class="nav-item">
                            <!-- Account Sidebar Toggle Button -->
                            <a id="sidebarNavToggler" href="javascript:;" role="button" class="px-2 px-md-3 font-size-3 nav-link link-black-100"
                        ...
                        <li class="nav-item d-none d-md-block">
                            ...
                            <a id="sidebarNavToggler1" href="javascript:;" role="button" class="font-size-3 nav-link link-black-100 position-relative"
